					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								$payments = $conn->query("SELECT p.*,s.name as sname, ef.ef_no,s.id_no FROM payments p 
								inner join student_ef_list ef on ef.id = p.ef_id 
								inner join student s on s.id = ef.student_id order by unix_timestamp(p.date_created) desc ");
