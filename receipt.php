...
FROM student_ef_list ef inner join student s on s.id = ef.student_id 
inner join courses c on c.id = ef.course_id  where ef.id = {$_GET['ef_id']}");
...
<div class="container-fluid">
	...
	<div class="flex">
		<div class="w-50">
			<p>MKPT No: <b><?php echo $id_no ?></b></p>
			<p>Student: <b><?php echo ucwords($sname) ?></b></p>
			<p>Class Year: <b><?php echo $class ?></b></p>
		</div>
		<?php if($_GET['pid'] > 0): ?>
		<div class="w-50">
