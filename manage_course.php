...
<div class="container-fluid" style="font-size: 13px;">
    <form action="" id="manage-course" method="post">
        ...
        <div class="col-lg-6 border-right">
            <h5><b>Class Year & Fee Details</b></h5>
            <hr>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="" rows="2" cols="40" maxlength="40" class="form-control" required=""><?php echo isset($description) ? $description :'' ?></textarea>
            </div>
        </div>
        <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="1000" min="1000" id="amount" class="form-control-sm text-right">
                </div>
    ...
    $('#manage-course').submit(function(e){
        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                $('#msg').html('<div class="alert alert-danger mx-2">Class year is already exist.</div>')
                end_load()
                }
            }
        })
